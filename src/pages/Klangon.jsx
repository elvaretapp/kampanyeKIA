...
import './Klangon.css';
import foto1 from '../images/kia_klangon.jpeg';
import foto2 from '../images/kia_klangon__2_.jpeg';
    ...
    <div className="app">
      ...
      <section className="detail-hero">
        <div className="container">
          <h1 className="detail-title">Jemput Bola Perekaman KIA Klangon, Bojonegoro</h1>
        ...
        <div className="container">
          <div className="foto-grid">
            <div className="foto-besar">
              <img src={foto1} alt="KIA Klangon" />
            </div>
            <div className="foto-kecil">
              <img src={foto2} alt="KIA Klangon 2" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="info-grid">
            <div className="info-deskripsi">
              <p>
                Program Jemput Bola Pelayanan KIA Merupakan Bagian Dari Upaya Dispendukcapil Bojonegoro Dalam Meningkatkan Akses Layanan Kependudukan Bagi Anak-Anak Usia 0-17 Tahun. KIA Ini Penting Sebagai Identitas Resmi Anak Yang Dapat Digunakan Untuk Berbagai Kebutuhan Administratif, Seperti Pendaftaran Sekolah, Pelayanan Kesehatan. Jemput Bola KIA Kali Ini Di Kelurahan Klangon, Kecamatan Bojonegoro. Dengan Jumlah Peserta 292 Anak Berhasil Direkam, Acara Berjalan Dengan Lancar Penuh Antusiasme Dan Semangat Dari Anak-Anak Dan Orang Tua.
              </p>
            </div>
            <div className="info-detail">
              <div className="info-item">
                ...
                <div>
                  ...
                  <span className="info-value">13 Oktober 2025</span>
                </div>
              </div>
              <div className="info-item">
                <span className="info-icon">📍</span>
                <div>
                  ...
                  <span className="info-value">Balai Kelurahan Klangon</span>
                </div>
              </div>
              <div className="info-item">
                <span className="info-icon">👤</span>
